...
import SwarmAnimations from "../components/SwarmAnimations";
import {
  Search,
  Cpu,
  Shield,
      ...
      <footer className="border-t border-slate-800 bg-[#0F1218] py-12 px-4 md:px-8 mt-16 text-center text-slate-500 text-xs font-mono" id="main_footer">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="space-y-1">
            ...
            <p className="text-slate-500 text-[11px] pt-1 pt-1.5">
              — AstronautSHE (PJ) &bull; AstronautSHE.com &bull; We Are <a href="https://theaicollective.art" target="_blank" rel="noopener noreferrer" className="text-[#4285F4] hover:text-blue-400 font-bold transition-colors duration-200">TheAiCollective.art</a><span className="tracking-normal select-none ml-1">🎨🍄🎵</span> &copy; 2026
            </p>
